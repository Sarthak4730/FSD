...
async function getInfo(url) {
  ...
  result.innerHTML = `
  <h3> ${locationIcon} <span>Location</span> = ${b.location.name} ( ${b.location.region}, ${b.location.country} ) ${b.current.is_day == "yes" ? dayIcon : nightIcon}</h3>
  <h2> ${tempIcon} <span>Temperature</span> : ${b.current.temperature} &deg;C</h2>
